...
class PermissionMatrixTest extends IntegrationTest {
    ...
    private static Stream<Row> matrix() {
        return Stream.of(
            ...
            row(HttpMethod.POST, "/api/incidents/X/resolve", "enologo"),
            row(HttpMethod.POST, "/api/incidents/X/assign", "enologo", "produccion"),
            row(HttpMethod.POST, "/api/incidents/X/acknowledge", "enologo", "laboratorio", "operario", "produccion"),
            row(HttpMethod.POST, "/api/tasks", "enologo", "produccion"),
            row(HttpMethod.POST, "/api/tasks/X/complete", "enologo", "laboratorio", "operario", "produccion"),
            row(HttpMethod.POST, "/api/tasks/X/cancel", "enologo", "produccion"),
